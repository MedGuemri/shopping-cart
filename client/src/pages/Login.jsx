    ...
    <div  className="flex justify-center flex-col items-center   ">
      ...
      <form className="mt-8 mb-2 w-80 min-h-screen  max-w-screen-lg sm:w-96">
        <div className="mb-4 flex flex-col gap-6">
          ...
          <Input type="password" required size="lg" label="Password" onChange={(e)=>setUserData({...userData, password:e.target.value})} />
        </div>
      ...
      <Button className="mt-6 text-slate-700  font-extrabold bg-yellow-500" fullWidth  onClick={()=> navigate("/Register")}>
         Sign up
        </Button>
      </form>
    </Card>
